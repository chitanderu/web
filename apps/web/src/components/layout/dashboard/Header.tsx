...
export const LayoutHeader = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[19] border-b-[0.5px] border-neutral-3 bg-neutral-1/80 pl-6 backdrop-blur">
      <nav className="flex h-16 items-center">
        <div className="flex items-center space-x-1 lg:space-x-3">
          ...
          <NextLink className="font-bold opacity-90 md:text-base" href="/">
            {title}
          </NextLink>
...
const RightBar = () => {
  ...
  return (
    <div className="relative mr-2 flex grow items-center justify-end space-x-2 lg:mr-4 lg:grow-0">
      ...
      <Avatar
        className="size-9 select-none rounded-full bg-neutral-3 ring-2 ring-neutral-3"
        height={24}
...
const SecondaryNavLine = () => {
  ...
  const pathname = fullPathname.replace('/dashboard', '')
