    ...
    >
      <div className="flex flex-col">
        {related.map((item, index) => {
          ...
          return (
            <MotionButtonBase
              className="flex items-center justify-between rounded-md p-2 duration-200 hover:bg-neutral-3"
              key={index}
              onClick={() => {
            ...
            >
              ...
              <MotionButtonBase
                className="-mr-2 shrink-0 select-none items-center p-2 text-xs text-neutral-7 duration-200 hover:text-red-400"
                onClick={(e) => {
                  e.stopPropagation()
                  setter(
                    produce((draft) => {
