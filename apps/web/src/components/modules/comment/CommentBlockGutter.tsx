...
function AvatarStack({
  ...
  return (
    <div className="flex items-center -space-x-1.5">
      {uniqueAvatars.map((u) => (
        <Avatar
          className="rounded-full ring-2 ring-neutral-1"
          imageUrl={u.avatar}
...
function DesktopGutterTrigger({
  ...
  return (
    ...
    >
      {hasComments ? (
        <button
          className="flex cursor-pointer items-center gap-1 rounded-full py-0.5 pl-0.5 pr-1.5 transition-colors hover:bg-neutral-2"
          type="button"
          onClick={onClick}
        >
        ...
        <button
          type="button"
          className={`flex size-7 cursor-pointer items-center justify-center rounded-md text-muted-foreground transition-all hover:bg-neutral-2 hover:text-foreground ${
...
function MobileGutterItem({
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="flex cursor-pointer items-center gap-0.5 rounded-full border border-neutral-3/80 bg-neutral-1/90 py-0.5 pl-0.5 pr-1.5 shadow-sm backdrop-blur-sm"
          type="button"
        >
  ...
  return (
    ...
    >
      ...
      {activePanel && panelAnchor && panelTop !== undefined && (
        <div
          className="absolute -left-2 ml-2 z-20 rounded-xl border border-neutral-3/80 bg-neutral-1 shadow-lg overflow-hidden"
          ref={panelRef}
