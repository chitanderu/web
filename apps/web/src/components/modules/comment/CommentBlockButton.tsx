...
export function CommentBlockButton({
  ...
  return (
    <button
      className="absolute z-10 flex size-6 items-center justify-center rounded-full bg-neutral-3/80 text-neutral-7 opacity-0 transition-opacity hover:bg-accent/20 hover:text-accent group-hover/comment-block:opacity-100"
      ref={btnRef}
      type="button"
      style={{
        top: btnPos.top,
