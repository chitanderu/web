  ...
  return (
    <m.div
      ...
      className={clsx(
        ...
        'flex min-h-[50px] flex-col bg-neutral-1/80 shadow-2xl backdrop-blur-md md:rounded-xl',
        'border-0 border-neutral-3 md:border',
      )}
      exit={{
        y: 20,
        opacity: 0,
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between px-4 py-2">
        ...
        >
          ...
          <svg aria-label="Algolia" height="19" role="img" width="77">
            <path
    ...
    return (
      <li
        ...
        className={clsx(
          ...
          'before:z-0 hover:before:bg-neutral-3/80',
          isSelect && 'before:bg-neutral-3/80',
        )}
        onMouseOver={() => {
          startTransition(() => {
      ...
      >
        ...
        >
          ...
          <span className="block min-w-0 shrink-0 grow-0 text-neutral-9">
            {item.subtitle}
          </span>
        </Link>
      </li>
